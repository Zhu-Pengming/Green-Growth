...
public class TimeLineAdapter extends RecyclerView.Adapter<TimeLineAdapter.TimeLineViewHolder> {
    ...
    public TimeLineAdapter(FragmentActivity activity, Context context, ArrayList<Integer> plant_id, ArrayList<String> plant_name, ArrayList<String> plant_var, ArrayList<String> plant_height, ArrayList<String> plant_target, OnDeleteItemClickListener deleteItemClickListener) {
    ...
    public void onBindViewHolder(@NonNull TimeLineViewHolder holder, @SuppressLint("RecyclerView") int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                // Call the onDeleteItemClick method of the callback interface
